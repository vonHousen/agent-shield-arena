...
class Settings(BaseSettings):
    ...
    attack_max_messages: int = Field(default=6, description="Attack Agent message budget per conversation")
    runner_max_turns: int = Field(default=8, description="Runner hard ceiling (safety net, > attack budget)")
