"""CLI entry point for running the Stream C demo scenario."""
...
def main() -> None:
    """Run the default attack scenario against the mock shielded system."""
    args = _parse_args()
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Stream C attack scenario.")
    parser.add_argument(
        "--events-path",
        type=Path,
